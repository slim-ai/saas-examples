...
![product homepage - connected registries tab selected](/blog/docs_connected_registries_homepage.png)
...
![search UI highlighting private library images](/blog/docs_connectors_search.png)
...
Clicking on an image version while browsing or in search results will bring you to the [Container Profile](/docs/container-profile) page for that image.  
